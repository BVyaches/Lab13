    ...
    public class ConsoleInteraction
    {
...

        {
            ...
            string[][] menuArray =
            {
                new string[]
                {
                    "Работа с первой коллекцией", "Работа со второй коллекцией",
                    "Вывести данные журналов", "Завершение работы"
                },
                new string[]
                {
                    "Создание таблицы заданного размера", "Добавление элемента", "Вывести хэш-таблицу",
                    "Удаление элемента из таблицы", "Изменение элемента по ключу", "Назад"
                },
                new string[]
                {
            ...
            //Console.WriteLine($"menu pos: {menuPosition}");
            //Console.ReadLine();
